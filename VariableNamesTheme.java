public class VariableNamesTheme {
    public static void main(String[] args) {
        ...
        char sign = '&';
        System.out.println("переменная хранит символ = " + sign);

        // код ошибки
        int errorCode = 404;
        System.out.println("Код ошибки " + errorCode);

        // тип сообщения (указал цело численное значение)
        int massageType = 2;
